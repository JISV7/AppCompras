...
import { View, Text, StyleSheet, Modal, FlatList, TouchableOpacity, ActivityIndicator, Pressable, TextInput, Alert, KeyboardAvoidingView, Platform } from 'react-native';
import { Ionicons, MaterialIcons } from '@expo/vector-icons';
import { useThemeColor } from '@/hooks/use-theme-color';
import { getMyLists, createList, ShoppingList } from '@/services/lists';
        ...
        >
            ...
            <View style={styles.info}>
                ...
                <Text style={[styles.details, { color: subTextColor }]}>
                    {item.items?.length || 0} artículos • {item.currency}{item.budget_limit || '0'}
                </Text>
            </View>
                    ...
                    <View style={[styles.content, { backgroundColor: bgColor }]}>
                        ...
                        {showCreate ? (
                            ...
                            >
                                ...
                                <Text style={[styles.createToggleText, { color: primaryColor }]}>Crear nueva lista</Text>
                            </TouchableOpacity>
                        )}
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    content: { borderRadius: 24, padding: 20, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, elevation: 5, width: '100%' },
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 },
    title: { fontSize: 18, fontWeight: 'bold' },
    listCard: { flexDirection: 'row', alignItems: 'center', padding: 12, borderRadius: 16, marginBottom: 8 },
    iconBox: { width: 40, height: 40, borderRadius: 10, backgroundColor: '#E8F5E9', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    info: { flex: 1 },
    ...
    createToggle: { 
        ...
        padding: 12, borderRadius: 12, borderWidth: 1, borderStyle: 'dashed', gap: 8
    },
    createToggleText: { fontWeight: 'bold' },
    
    createContainer: { gap: 12 },
    input: { padding: 12, borderRadius: 12, fontSize: 16 },
    createButtons: { flexDirection: 'row', justifyContent: 'flex-end', gap: 12, alignItems: 'center' },
    cancelBtn: { padding: 10 },
    confirmBtn: { paddingVertical: 10, paddingHorizontal: 20, borderRadius: 10, minWidth: 120, alignItems: 'center' },
