...
export default function ForgotPasswordScreen() {
	...
	const handleSendResetLink = async () => {
		...
		try {
			...
			Alert.alert(
				"Correo enviado",
				"Revisa tu bandeja de entrada para ver el código.",
			);
			...
			Alert.alert(
				"Error",
				"No se pudo enviar el código de restablecimiento. Inténtalo de nuevo.",
			);
		} finally {
			setLoading(false);
		}
				...
				>
					<View style={styles.content}>
						...
						<Text style={[styles.bodyText, { color: textSecondaryColor }]}>
							¡No te preocupes! Suele pasar. Por favor ingresa el correo
